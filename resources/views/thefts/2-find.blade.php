<x-blehout>
    ...
    <a href="/thefts/edit">Tilbake</a>
                ...
                <x-button href="/thefts/edit" :active="request()->is('/thefts/edit')">Tilbake</x-nav>
